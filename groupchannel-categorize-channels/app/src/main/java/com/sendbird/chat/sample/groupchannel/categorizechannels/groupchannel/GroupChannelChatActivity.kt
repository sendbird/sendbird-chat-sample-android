...
import com.sendbird.chat.sample.groupchannel.categorizechannels.view.ChatInputView
import com.sendbird.chat.sample.groupchannel.categorizechannels.user.ChatMemberListActivity
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.ChatRecyclerDataObserver
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.Constants
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.FileUtils
...
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.TextUtils
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.copy
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.showAlertDialog
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.showInputDialog
import com.sendbird.chat.sample.groupchannel.categorizechannels.util.showListDialog
...
class GroupChannelChatActivity : AppCompatActivity() {
                ...
                showInputDialog(
                    ...
                    getString(R.string.cancel),
                    {
                        if(it.isBlank()) {
                            ...
                            if(channel.name == it) return@showInputDialog
                            updateChannelView(GroupChannelUpdateParams()
                                .apply { this.name = it }, channel)
                        }
                    },
                )
                true
    ...
    private fun updateChannelView(params: GroupChannelUpdateParams, channel: GroupChannel) {
