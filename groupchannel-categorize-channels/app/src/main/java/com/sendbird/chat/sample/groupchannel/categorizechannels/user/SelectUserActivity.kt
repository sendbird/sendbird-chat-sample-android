package com.sendbird.chat.sample.groupchannel.categorizechannels.user
...
import com.sendbird.chat.sample.groupchannel.categorizechannels.groupchannel.GroupChannelChatActivity
...
class SelectUserActivity : AppCompatActivity() {
    ...
    private fun createChannel() {
        ...
        // Show input dialog to get CustomType and set it to customType
        showInputDialog(
            ...
            { input ->
                // Create GroupChannel with customType(String) and userIds(List<String>)
