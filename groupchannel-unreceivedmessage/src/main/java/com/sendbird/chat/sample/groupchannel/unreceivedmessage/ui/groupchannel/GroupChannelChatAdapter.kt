...
import com.sendbird.chat.sample.groupchannel.databinding.ListItemChatAdminBinding
import com.sendbird.chat.sample.groupchannel.databinding.ListItemChatImageReceiveBinding
import com.sendbird.chat.sample.groupchannel.databinding.ListItemChatImageSendBinding
import com.sendbird.chat.sample.groupchannel.databinding.ListItemChatReceiveBinding
import com.sendbird.chat.sample.groupchannel.databinding.ListItemChatSendBinding

class GroupChannelChatAdapter(
    private val longClickListener: OnItemLongClickListener,
    private val failedItemClickListener: OnFailedItemClickListener,
    private val checkMessageDeliveryStatus: (BaseMessage) -> Boolean
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            is GroupChatSendViewHolder -> {
                ...
                val isDelivered = checkMessageDeliveryStatus(message)
                holder.bind(message, showDate, showTime, isDelivered)
            }
            ...
            is GroupChatImageSendViewHolder -> {
                val message = getItem(position)
                val isDelivered = checkMessageDeliveryStatus(message)
                holder.bind(message as FileMessage, showDate, showTime, isDelivered)
            }
        ...
        fun bind(
            ...
            if (message.sendingStatus == BaseMessage.SendingStatus.SUCCEEDED) {
                ...
                binding.deliveryStatus.apply {
                    ...
                    setImageResource(
                        if (isDelivered) R.drawable.ic_double_thick else R.drawable.ic_check
                    )
                }
                if (showDate) {
