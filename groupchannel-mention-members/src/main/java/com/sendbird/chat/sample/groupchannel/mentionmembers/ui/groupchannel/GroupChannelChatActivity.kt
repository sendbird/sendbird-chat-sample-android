package com.sendbird.chat.sample.groupchannel.mentionmembers.ui.groupchannel
...
import com.sendbird.chat.sample.groupchannel.mentionmembers.R
import com.sendbird.chat.sample.groupchannel.mentionmembers.databinding.ActivityGroupChannelChatBinding
import com.sendbird.chat.sample.groupchannel.mentionmembers.ui.user.ChatMemberListActivity
import com.sendbird.chat.sample.groupchannel.mentionmembers.ui.user.SelectUserActivity
...
class GroupChannelChatActivity : AppCompatActivity() {
    ...
    private fun updateMessage(msg: String, baseMessage: BaseMessage) {
        ...
        if (mentionedUsersIds.isNotEmpty()) {
            params.mentionedUserIds = mentionedUsersIds
        }
