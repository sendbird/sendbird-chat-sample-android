package com.sendbird.chat.sample.groupchannel.report.ui.groupchannel
...
import com.sendbird.chat.sample.groupchannel.report.databinding.ActivityGroupChannelChatBinding
import com.sendbird.chat.sample.groupchannel.report.ui.user.ChatMemberListActivity
import com.sendbird.chat.sample.groupchannel.report.ui.user.SelectUserActivity
...
class GroupChannelChatActivity : AppCompatActivity() {
    ...
    private fun reportChannel() {
        currentGroupChannel?.report(ReportCategory.SUSPICIOUS, "Report description") handler@{
            if (it != null) {
                showToast("Failed")
                return@handler
            }
