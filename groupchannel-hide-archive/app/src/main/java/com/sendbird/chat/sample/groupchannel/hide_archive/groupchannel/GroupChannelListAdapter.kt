...
import com.sendbird.chat.sample.groupchannel.hide_archive.util.toChatTime
import com.sendbird.chat.sample.groupchannel.hide_archive.databinding.ListItemChannelBinding

class GroupChannelListAdapter(
    private val listener: OnItemClickListener,
    private val onItemLongClick: (View, GroupChannel) -> Unit
    ...
    inner class GroupChannelListViewHolder(private val binding: ListItemChannelBinding) :
        ...
        init {
            ...
            itemView.setOnLongClickListener {
                onItemLongClick(itemView, groupChannelList[adapterPosition])
                false
            }
        }
        ...
        fun bind(groupChannel: GroupChannel) {
            ...
            val isArchived = when (groupChannel.hiddenState) {
                ...
                HiddenState.HIDDEN_ALLOW_AUTO_UNHIDE -> " (Hidden)"
                else -> ""
            }
            val channelName =
