package com.sendbird.chat.sample.groupchannel.categorizemessages.groupchannel
...
import com.sendbird.chat.sample.groupchannel.categorizemessages.view.ChatInputView
import com.sendbird.chat.sample.groupchannel.categorizemessages.user.ChatMemberListActivity
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.ChatRecyclerDataObserver
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.Constants
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.FileUtils
import com.sendbird.chat.sample.groupchannel.categorizemessages.user.SelectUserActivity
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.SharedPreferenceUtils
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.TextUtils
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.copy
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.showAlertDialog
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.showInputDialog
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.showListDialog
...
import com.sendbird.chat.sample.groupchannel.categorizemessages.databinding.ActivityGroupChannelChatBinding
import com.sendbird.chat.sample.groupchannel.categorizemessages.categorize.GroupChannelCategorizeMessagesActivity
...
class GroupChannelChatActivity : AppCompatActivity() {
        ...
        adapter = GroupChannelChatAdapter({ baseMessage, view ->
            view.setOnCreateContextMenuListener { contextMenu, _, _ ->
                if (SendbirdChat.currentUser != null && baseMessage.sender?.userId == SendbirdChat.currentUser!!.userId) {
                    ...
                    val categorizeMenuTitleResId =
                        if (baseMessage.customType == CATEGORIZE) R.string.uncategorize_message else R.string.categorize_message
                    val categorizeUnCategorizeMenu =
                        contextMenu.add(Menu.NONE, 3, 3, getString(categorizeMenuTitleResId))
                    categorizeUnCategorizeMenu.setOnMenuItemClickListener {
                        updateMessageCustomType(baseMessage)
                        return@setOnMenuItemClickListener true
                    }
                }
                if (baseMessage is UserMessage) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.categorize_messages -> {
                startActivity(GroupChannelCategorizeMessagesActivity.newIntent(this, channelUrl))
                true
            }
    ...
    companion object {
        const val CATEGORIZE = "categorize_message"
    }
}