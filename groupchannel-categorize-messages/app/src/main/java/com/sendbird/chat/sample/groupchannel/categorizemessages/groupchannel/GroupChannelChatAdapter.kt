...
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.ListUtils
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.equalDate
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.equalTime
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.toTime
import com.sendbird.chat.sample.groupchannel.categorizemessages.databinding.*
import com.sendbird.chat.sample.groupchannel.categorizemessages.groupchannel.GroupChannelChatActivity.Companion.CATEGORIZE
...
class GroupChannelChatAdapter(
    ...
    inner class GroupChatSendViewHolder(private val binding: ListItemChatSendBinding) :
        ...
        fun bind(
            ...
            binding.categorizeView.isVisible = message.customType == CATEGORIZE
        }
    }
