...
import com.sendbird.chat.sample.groupchannel.categorizemessages.databinding.ListItemChatCategorizeImageBinding
import com.sendbird.chat.sample.groupchannel.categorizemessages.databinding.ListItemChatCategorizeMessageBinding
import com.sendbird.chat.sample.groupchannel.categorizemessages.util.toTime

class GroupChannelCategorizeMessagesAdapter :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == VIEW_TYPE_IMAGE) {
            ImageViewHolder(
                ListItemChatCategorizeImageBinding.inflate(
            ...
            MessageViewHolder(
                ListItemChatCategorizeMessageBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
                )
    ...
    inner class ImageViewHolder(private val binding: ListItemChatCategorizeImageBinding) :
    ...
    inner class MessageViewHolder(private val binding: ListItemChatCategorizeMessageBinding) :
        RecyclerView.ViewHolder(binding.root) {
