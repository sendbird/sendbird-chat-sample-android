...
import com.sendbird.chat.sample.typingindicator.R
import com.sendbird.chat.sample.typingindicator.databinding.ActivityGroupChannelChatBinding
import com.sendbird.chat.sample.typingindicator.ui.user.ChatMemberListActivity
import com.sendbird.chat.sample.typingindicator.ui.user.SelectUserActivity
...
class GroupChannelChatActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        binding.chatInputView.setOnMessageChangedListener { currentGroupChannel?.startTyping() }
    }
    ...
    /**
    Add a channel handler to listen for channel typing status
     */
