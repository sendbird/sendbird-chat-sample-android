...
import com.sendbird.chat.sample.groupchannel.dndsnooze.base.BaseFragment
import com.sendbird.chat.sample.groupchannel.dndsnooze.databinding.FragmentGroupChannelListBinding
import com.sendbird.chat.sample.groupchannel.dndsnooze.time.DNDFragment
import com.sendbird.chat.sample.groupchannel.dndsnooze.time.SnoozeFragment
...
class GroupChannelListFragment :
    ...
    // This is for the menu items in the top right corner of the screen
    // When the user clicks on the DND or Snooze menu item, the corresponding fragment is shown
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.dnd -> {
                DNDFragment().show(childFragmentManager, "DND_TAG")
                true
            }
            R.id.snooze -> {
                SnoozeFragment().show(childFragmentManager, "SNOOZE_TAG")
                true
            }
