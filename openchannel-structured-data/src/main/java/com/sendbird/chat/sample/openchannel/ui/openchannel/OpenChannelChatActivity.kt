...
class OpenChannelChatActivity : AppCompatActivity() {
    ...
    private fun sendMessage(msg: String) {
        ...
        val params = UserMessageCreateParams()
            .setMessage(msg.trim())
            .setData(
                buildDataJson(getRandomColor(), getRandomColor(), Random.nextDouble(30.0), Random.nextDouble(1.0))
            )
    ...
    companion object {
        ...
        fun buildDataJson(color: Int, background: Int, textSize: Double, letterSpacing: Double): String {
