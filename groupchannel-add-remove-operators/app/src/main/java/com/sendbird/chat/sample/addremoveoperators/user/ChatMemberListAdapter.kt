package com.sendbird.chat.sample.addremoveoperators.user
    ...
    companion object {
        val diffCallback = object : DiffUtil.ItemCallback<Member>() {
            ...
            override fun areContentsTheSame(oldItem: Member, newItem: Member): Boolean {
                return oldItem.nickname == newItem.nickname && oldItem.plainProfileImageUrl == newItem.plainProfileImageUrl && oldItem.role == newItem.role
            }
        }
    }
