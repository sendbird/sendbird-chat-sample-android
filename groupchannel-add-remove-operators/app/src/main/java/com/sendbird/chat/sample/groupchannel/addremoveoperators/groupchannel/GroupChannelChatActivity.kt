package com.sendbird.chat.sample.groupchannel.addremoveoperators.groupchannel
...
import com.sendbird.chat.sample.groupchannel.addremoveoperators.view.ChatInputView
import com.sendbird.chat.sample.groupchannel.addremoveoperators.user.ChatMemberListActivity
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.ChatRecyclerDataObserver
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.Constants
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.FileUtils
import com.sendbird.chat.sample.groupchannel.addremoveoperators.user.SelectUserActivity
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.SharedPreferenceUtils
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.TextUtils
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.copy
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.showAlertDialog
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.showInputDialog
import com.sendbird.chat.sample.groupchannel.addremoveoperators.util.showListDialog
...
class GroupChannelChatActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.member_list -> {
                // When the member list menu is selected, open the MemberListActivity.
                // So we can manage(Operator) the member of the channel.
