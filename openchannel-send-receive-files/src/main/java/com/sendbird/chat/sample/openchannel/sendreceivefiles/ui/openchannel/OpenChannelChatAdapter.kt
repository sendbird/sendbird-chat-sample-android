package com.sendbird.chat.sample.openchannel.sendreceivefiles.ui.openchannel
...
import com.sendbird.chat.sample.openchannel.sendreceivefiles.databinding.*
...
class OpenChannelChatAdapter(
    ...
    inner class FileReceiveViewHolder(private val binding: ListItemChatFileReceiveBinding) : BaseViewHolder(binding) {
        fun bind(message: FileMessage) {
    ...
    inner class FileSendViewHolder(private val binding: ListItemChatFileSendBinding) : BaseViewHolder(binding) {
        fun bind(message: FileMessage) {
            if (message.sendingStatus == BaseMessage.SendingStatus.SUCCEEDED) {
                binding.progressSend.visibility = View.GONE
                binding.chatErrorButton.visibility = View.GONE
