package com.sendbird.chat.sample.openchannel.thumbnails.ui.openchannel
...
import com.sendbird.chat.sample.openchannel.thumbnails.R
import com.sendbird.chat.sample.openchannel.thumbnails.databinding.ActivityOpenChannelChatBinding
...
class OpenChannelChatActivity : AppCompatActivity() {
    ...
    private fun updateChannel(name: String, channel: OpenChannel) {
        ...
        val params = OpenChannelUpdateParams().apply {
            this.name = name
        }
